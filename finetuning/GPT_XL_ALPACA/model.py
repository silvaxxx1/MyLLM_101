...
GPT_CONFIG_124 = {
    ...
    "n_heads" : 12,               # Number of attention heads in each layer (parallel attention mechanisms)
    "n_layers" : 12,              # Number of transformer layers (stacked attention layers with feed-forward networks)
    "drop_rate" : 0.1,             # Dropout rate to regularize the model and prevent overfitting
